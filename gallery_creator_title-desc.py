...
__author__ = 'Thomas Miller'
__author_email__ = 'tommiller@rellimmot.com'
...
# configuration
output_file = "portfolio-gallery-2.yml"
input_file = output_file
image_path = "portfolio-gallery-2"
extensions= ['jpg', 'png']
